...
subgraph "业务逻辑层"
E[app/services/<br/>服务组件]
F[app/models/<br/>数据模型]
G[app/prompts/<br/>LLM提示词]
end
subgraph "配置层"
H[app/config.py<br/>配置管理]
I[app/dependencies.py<br/>共享依赖]
end
subgraph "数据层"
J[data/<br/>样本数据]
K[docs/<br/>文档]
...
该系统为小说改编为剧本提供了高效的技术解决方案，具有良好的可扩展性和维护性。